/**
 * De' Lead — lead capture for the Corporate Training site (corporate.deleadint.com).
 *
 ...
 *   3. Copy the /exec URL → set it as APPS_SCRIPT_URL_CORPORATE in:
...
var SITE_LABEL = "Corporate Training";
var SITE_URL = "https://corporate.deleadint.com";
