/**
 * De' Lead — lead capture for the TinkerChamps site (tc.deleadint.com).
 *
 ...
 *   3. Copy the /exec URL → set it as APPS_SCRIPT_URL_TINKERCHAMPS in:
...
var SITE_LABEL = "TinkerChamps";
var SITE_URL = "https://tc.deleadint.com";
