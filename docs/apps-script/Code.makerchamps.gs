/**
 * De' Lead — lead capture for the MakerChamps site (mc.deleadint.com).
 *
 ...
 *   3. Copy the /exec URL → set it as APPS_SCRIPT_URL_MAKERCHAMPS in:
...
var SITE_LABEL = "MakerChamps";
var SITE_URL = "https://mc.deleadint.com";
