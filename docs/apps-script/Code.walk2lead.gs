/**
 * De' Lead — lead capture for the Walk2Lead site (w2l.deleadint.com).
 *
 ...
 *   3. Copy the /exec URL → set it as APPS_SCRIPT_URL_WALK2LEAD in:
...
var SITE_LABEL = "Walk2Lead";
var SITE_URL = "https://w2l.deleadint.com";
