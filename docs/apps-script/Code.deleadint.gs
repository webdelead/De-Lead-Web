/**
 * De' Lead — lead capture for the DE' LEAD INTERNATIONAL site (deleadint.com).
 *
 ...
 *   3. Copy the /exec URL → set it as APPS_SCRIPT_URL_DELEADINT in:
...
var SITE_LABEL = "De' Lead International";
var SITE_URL = "https://deleadint.com";
