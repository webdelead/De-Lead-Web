...
- **Marketing sites are pixel-frozen**: the designs are client-approved. Copy the original
  ...
  - The move off verbatim CSS/JS to Tailwind + `@delead/ui` components is planned as a
    separate, screenshot-gated effort — [`docs/MIGRATION-CSS-TO-TAILWIND.md`](docs/MIGRATION-CSS-TO-TAILWIND.md).
    Until a site is migrated on that track, this rule stands.
