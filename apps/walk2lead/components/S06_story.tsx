...
const tag =
  "mb-2.5 inline-block rounded-full bg-cream-2 px-2.5 py-1 text-[0.7rem] font-bold uppercase tracking-[0.1em] text-accent";
          ...
          <div className="relative mt-[52px] pl-8 [border-left:2px_solid_var(--color-line)]">
            {BEATS.map((b) => (
              ...
              >
                ...
                <div className="mb-1.5 font-serif text-[1.05rem] font-bold text-accent">{b.yr}</div>
