      ...
      <section className="section" id="outcomes">
        <div className="wrap">
          <div className="shead simple reveal">
            ...
            <h2 className="h2" style={{ marginTop: "10px" }}>What learners go on to do</h2>
            <p className="sh-note">A few of the students who started in a DLI Education classroom.</p>
          </div>
          <div className="ogrid reveal">
            <figure className="ocard">
              <div className="o-top"><span className="o-badge">EV</span><div><div className="o-name">Evana Eliza Vinoj</div><div className="o-where">Sharjah Indian School, UAE</div></div></div>
              <p className="o-win">Digitised a village library with a Python application. Won the Sharjah Award for Educational Excellence, Distinguished Student, with a Dh30,000 scholarship.</p>
              <span className="o-tag">Python</span>
            </figure>
            <figure className="ocard">
