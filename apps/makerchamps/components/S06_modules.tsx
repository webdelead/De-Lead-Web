...
const cardBase =
  "stagger-item tilt-hover relative rounded-[var(--radius-md)] p-[22px] shadow-[var(--shadow-card)] transition-transform duration-300 ease-out odd:[--tilt:-1deg] even:[--tilt:1deg]";
const kindClass = {
