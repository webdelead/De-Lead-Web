...
const card =
  "stagger-item tilt-hover relative rounded-[var(--radius-md)] bg-white p-5 shadow-[var(--shadow-card)] transition-transform duration-300 ease-out odd:[--tilt:1deg] even:[--tilt:-1deg]";
